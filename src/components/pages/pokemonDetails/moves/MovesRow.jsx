...
import { normalizeMachineName } from "../../../../utils/utils";
...
const MovesRow = ({ move }) => {
  ...
  return (
    <tr className="table__row table__row_body">
      ...
      <td className="table__cell table__cell_body">{move.name}</td>
      <td className="table__cell table__cell_body">
        <TypeChip type={move.type} size="medium" />
      </td>
      <td className="table__cell table__cell_body">{move.category}</td>
      <td className="table__cell table__cell_body">
